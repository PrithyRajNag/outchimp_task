        ...
        <div class="col-lg-12 m-3">
            ...
            <div class="card border-success">
                <h4 class="card-header bg-success d-flex justify-content-between">
                    <span class="text-light align-self-center"> Category List</span>
                    <a href="{{route('category.create')}}" class="btn btn-light"><i class="fas fa-plus-circle"></i>&nbsp;
                        ADD</a>
                </h4>
                        ...
                        <table class="table table-striped text-canter">
                            ...
                            @foreach($contentData as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('category.edit', $item->uuid)}}"
